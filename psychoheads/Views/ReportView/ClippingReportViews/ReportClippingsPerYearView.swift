//
//  ReportClippingsPerYearView.swift
//  psychoheads
//
...
struct ReportClippingsPerYearView: View {
    ...
    var body: some View {
        if #available(iOS 17.0, *) {
            ...
            Chart {
                ForEach(sourceModel.clippingsPerYear, id: \.year) { data in
                    BarMark(
...
struct ReportClippingsPerYearView_Previews: PreviewProvider {
